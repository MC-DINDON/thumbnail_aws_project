...
def upload_to_s3(bucket, key, image, img_size):
    ...
    #WARNING: might need to comment out ACL line if breaking code.
    #Solved by manually editing ACL permissions + public access read on the s3 bucket via aws console
